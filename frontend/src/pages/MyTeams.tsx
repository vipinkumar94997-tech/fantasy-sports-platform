    ...
    <div className="min-h-screen bg-dark-400">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {teams.map((team, i) => (
              <div key={team.id || i} className="card p-5">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h3 className="text-white font-bold">
                      Team {team.teamNumber || i + 1}
                    </h3>
                    <p className="text-gray-400 text-xs mt-0.5">
                      {team.match?.team1Name} vs {team.match?.team2Name}
                    </p>
                  </div>
                  <span
                    className={`text-xs px-2 py-1 rounded-full font-semibold ${
                  ...
                  >
                    {team.match?.status?.toUpperCase() || "N/A"}
                  </span>
                </div>
                <div className="flex items-center justify-between pt-3 border-t border-white/10">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-gray-500 text-xs">Team No.</p>
                  ...
                  <button
                    onClick={() => navigate(`/match/${team.matchId}`)}
                    className="text-primary-400 text-sm font-semibold hover:text-primary-300"
                  >
                    View Match →
                  </button>
